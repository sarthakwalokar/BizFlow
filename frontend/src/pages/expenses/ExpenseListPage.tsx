...
export const ExpenseListPage: React.FC = () => {
  ...
  const fetchExpenses = async (pageNumber = 0) => {
    try {
      ...
      setExpenses(listRes.content);
      setPage(listRes.pageNumber);
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-zinc-100">
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="px-2.5 py-1 rounded-lg border border-zinc-200 text-xs"
              />
            </div>
            <div className="flex items-center space-x-2">
                  ...
                  expenses.map((exp) => {
                    ...
                    return (
                      <tr key={exp.id} className="hover:bg-zinc-50/70 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          <span className="px-2 py-0.5 rounded-md bg-zinc-100 text-zinc-700 text-[10px] font-medium">
                            {exp.paymentMethod}
                          </span>
                        </td>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-zinc-200 text-xs font-bold focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
                  />
                </div>
